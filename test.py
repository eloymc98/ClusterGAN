...
np.save('colors_new_test_patch5_data_rgb.npy', dataset)
np.save('colors_new_test_patch5_labels_rgb.npy', labels)
np.save('colors_new_test_patch5_imanumbers_rgb.npy', ima_numbers)
f.close()